...
sig_resCRS_p05 <- dplyr::filter(resCRS_df, padj < 0.05 & abs(log2FoldChange) > lfc.cutoff)
sig_resCRS_p01 <- dplyr::filter(resCRS_df, padj < 0.01 & abs(log2FoldChange) > lfc.cutoff)


write_csv(sig_resCRS_p05, "../results/DEresults_sig_crsVSana_p05.csv")
write_csv(sig_resCRS_p01, "../results/DEresults_sig_crsVSana_p01.csv")
```
# MA Plot
...
```{r}
maPlotCRS_05 <- makeMA_05(resCRS_df) + ggtitle("CRS vs Anaerobic (ref)") +theme(
    legend.text = element_text(size=rel(0.9)),  
    legend.title = element_blank(),
    legend.position = "top") +
  guides(colour = guide_legend(override.aes = list(alpha=0.5, size=3))) +
  scale_colour_manual(values = alpha(c("limegreen",  "gray60"),0.5), labels = c("Upregulated (10)", "NS"))

maPlotCRS_05
ggsave(plot = maPlotCRS_05, filename = "../figures/crsVSana/maPlotCRS_anaREF_05.pdf", device = "pdf", height = 5, width = 6)
ggsave(plot = maPlotCRS_05, filename = "../figures/crsVSana/maPlotCRS_anaREF_05.png", device = "png", height = 5, width = 6)


maPlotCRS_01 <- makeMA_01(resCRS_df) + ggtitle("CRS vs Anaerobic (ref)") +theme(
    legend.text = element_text(size=rel(0.9)),  
    legend.title = element_blank(),
    legend.position = "top") +
  guides(colour = guide_legend(override.aes = list(alpha=0.5, size=3))) +
...
maPlotCRS_01
ggsave(plot = maPlotCRS_01, filename = "../figures/crsVSana/maPlotCRS_anaREF_01.pdf", device = "pdf", height = 4, width = 6)
ggsave(plot = maPlotCRS_01, filename = "../figures/crsVSana/maPlotCRS_anaREF_01.png", device = "png", height = 4, width = 6)

maPlotCRS_001 <- makeMA_001(resCRS_df) + ggtitle("CRS vs Anaerobic (ref) 001") +theme(
    legend.text = element_text(size=rel(0.9)),  
    legend.title = element_blank(),
    legend.position = "top") +
  guides(colour = guide_legend(override.aes = list(alpha=0.5, size=3))) +
  scale_colour_manual(values = alpha(c("limegreen", "gray60"),0.5), labels = c("Upregulated (6)", "NS"))
...
```{r}
gathered_cyto_crs <- inner_join(DE_meta, gathered_cyto_crs, by = c("SAMPLE_NAME" = "SAMPLE_NAME"))
```
...
```{r}
volcano_crs_01 <- EnhancedVolcano(resCRS_df,
...
```{r}
volcano_crs_05 <- EnhancedVolcano(resCRS_df,
                lab = resCRS_df$symbol,
                x = 'log2FoldChange',
                y= 'pvalue',
                xlim = c(-5,5),
...
```
```{r}
ggsave(volcano_crs_01, filename = "../figures/crsVSana/volcano_crs_01.pdf", device = "pdf", height = 6, width = 6)
ggsave(volcano_crs_05, filename = "../figures/crsVSana/volcano_crs_05.pdf", device = "pdf", height = 6, width = 6)
ggsave(volcano_crs_001, filename = "../figures/crsVSana/volcano_crs_001.pdf", device = "pdf", height = 6, width = 6)
```
```{r}
ggsave(volcano_crs_01, filename = "../figures/crsVSana/volcano_crs_01.png", device = "png", height = 6, width = 6)
ggsave(volcano_crs_05, filename = "../figures/crsVSana/volcano_crs_05.png", device = "png", height = 6, width = 6)
...
```{r}
volcano_CRS_group_05 <- EnhancedVolcano(res_dfCRSvolcanogenes,
...
volcano_CRS_group_05
```

```{r}
volcano_CRS_group_01 <- EnhancedVolcano(res_dfCRSvolcanogenes,
                lab = res_dfCRSvolcanogenes$siggenes,
                labSize = 3.5,
                boxedLabels = FALSE,
                drawConnectors = TRUE,
...
```{r}
ggsave(volcano_CRS_group_01, filename = "../figures/crsVSana/volcano_CRS_group_01.pdf", device = "pdf", height = 6, width = 6)
ggsave(volcano_CRS_group_05, filename = "../figures/crsVSana/volcano_CRS_group_05.pdf", device = "pdf", height = 6, width = 6)
ggsave(volcano_CRS_group_001, filename = "../figures/crsVSana/volcano_CRS_group_001.pdf", device = "pdf", height = 6, width = 6)
```
```{r}
ggsave(volcano_CRS_group_01, filename = "../figures/crsVSana/volcano_CRS_group_01.png", device = "png", height = 6, width = 6)
ggsave(volcano_CRS_group_05, filename = "../figures/crsVSana/volcano_CRS_group_05.png", device = "png", height = 6, width = 6)
